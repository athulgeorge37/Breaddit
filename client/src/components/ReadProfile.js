...
// component imports
import FollowerCard from '../pages/FollowerCard';
import PostContent from './PostContent';
import ProfilePicture from '../components/ProfilePicture';
import Loading from './Loading';

// rest api requests imports
import { get_all_posts_by_username, get_all_posts_by_curr_user } from '../rest_api_requests/PostRequests';
...
import { get_curr_user_details, get_user_profile_details, sign_out } from "../rest_api_requests/UserRequests";
...
function ReadProfile({ set_toggle_edit_page }) {
    ...
    const initialise_user_details = async () => {
        ...
        // console.log("current_user.username", current_user.username)
        if (username_route === current_user.username) {
            response = await get_curr_user_details();
    ...
    const initialise_counts = async () => {
        ...
        const follower_response = await get_count_of_type_by_username("follower", username_route);
        ...
        const following_response = await get_count_of_type_by_username("following", username_route);
    ...
    const get_all_follower_data = async () => {
        ...
        const response = await get_accounts_of_type_by_username("follower", user_profile_details.username);
        // console.log(response)
        if (response.error) {
            console.log(response)
            return
    ...
    const get_all_following_data = async () => {
        ...
        const response = await get_accounts_of_type_by_username("following", user_profile_details.username);
        // (response)
        if (response.error) {
            console.log(response)
            return
                    ...
                    <div className="profile_card_and_user_posts">
                        ...
                        <div className="read_only_profile_card">
                            ...
                            <div className="section_one">
                                <ProfilePicture 
                                    profile_picture_url={user_profile_details.profile_pic}
                                ...
                                <div className="name_and_date_joined">
                                    ...
                                    <div className="date_joined">
                                        {get_current_date(user_profile_details.createdAt)}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="section_two">
                                <div className="profile_stats">
                                    <div 
                                        ...
                                        onClick={() => handle_set_follower_card("follower")}
                                    >
                                        <div className="follower_count">{followers.count}</div>
                                        <div className="follower_text">Followers</div>
                                    </div>

                                    <div 
                                        className="following count_and_text"
                                        onClick={() => handle_set_follower_card("following")}
                                    >
                                        <div className="following_count">{following.count}</div>
                                    ...
                                    <div className="bread_crumbs count_and_text">
                                        ...
                                        <div className="bread_crumbs_text">Points</div>
                                    </div>
                                </div>
                                ...
                                <div className="about_me">
                                    {
                                        ...
                                        <div 
                                            className="bio"
                                            dangerouslySetInnerHTML={{__html: DOMPurify.sanitize(user_profile_details.bio)}}
                                        >
                                ...
                                <div className="profile_btns">
                                    {
                                        ...
                                        >
                                            {is_following_user ? "Following" : "Follow"}
                                        </button>
                                    }
                                </div>
                        ...
                        <div className="user_posts">
                            {
                                ...
                                <>
                                {
                                    ...
                                    <div className='not_following'>
                                        Follow {username_route} to see their recent activity
                                    </div>
                                }
                                </>
                            }
