...
function EditThreadLogo({ set_logo_url, logo_url }) {
        ...
        <div className="EditThreadLogo">
            {editing_img ? (
                <div className="open_edit_mode">
                    ...
                    <div className="img_btns_and_sliders">
                        <div className="sliders">
                            ...
                            <input
                                className="rotate_slider slider"
                                id="rotate"
                                type="range"
                                defaultValue={0}
                                min={0}
                        ...
                        <div className="img_btns">
                            ...
                            {(picture.img === null || logo_url === null) && (
                ...
                <div className="closed_edit_mode">
                    {upload_img_to_cloud_loading ? (
                        <div className="loading_div">
                            <Loading />
                        </div>
                    ) : (
                        <ProfilePicture
                            profile_picture_url={logo_url ?? null}
                            disable_tooltip
                            img_size={200}
                            margin_right={0}
                        />
