...
function PaginatedTableRowPosts({ post_details, set_curr_post }) {
    ...
    return (
        ...
        >
            <td className="title item">{post_details.title}</td>
            ...
            <td className="up_votes item">{post_data.up_votes}</td>
            <td className="down_votes item">{post_data.down_votes}</td>

            <td className="no_of_comments item">{post_data.total_comments}</td>
            <td
                className={`is_inappropriate_item item ${
                    post_details.is_inappropriate ? "inappropriate" : ""
                }`}
            >
