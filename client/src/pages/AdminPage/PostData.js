...
import PaginatedTableRowPosts, { TABLE_HEADERS } from './PaginatedTableRowPosts'
...
function PostData({ user_id, username, profile_pic }) {
    ...
    return (
        <div className='PostData'>
            <PaginatedTable
                get_data={get_posts}
                determine_data_path={(response) => response.data.get_posts_by_user_id}
                user_id={user_id}
