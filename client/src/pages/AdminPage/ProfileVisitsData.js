...
function ProfileVisitsData({ user_id, username }) {
    ...
    const [get_profile_visitor_data] = useLazyQuery(
        GET_PROFILE_VISIT_DATE_DATA
    );
    ...
    const get_all_follower_data = async (dates_and_labels) => {
        ...
        chart_data_copy.datasets[0].data =
            profile_visitors_response.data.get_total_profile_visits_before_date;
        ...
        <div className="ProfileVisitsData">
            <PaginatedTable
                ...
                determine_data_path={(response) =>
                    response.data.get_profile_visitors_by_user_id
                }
