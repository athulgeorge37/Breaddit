...
function StaticPostContent({ post_details }) {
    ...
    const [is_inappropriate, set_is_inappropriate] = useState(post_details.is_inappropriate);
    const [update_is_inappropriate] = useMutation(UPDATE_IS_INAPPROPRIATE_STATUS);
            ...
            <div className="main_content_and_votes">
                ...
                <div className="text_content">
                    ...
                    >
                        <h1 
                            className="Title"
                            dangerouslySetInnerHTML={{__html: DOMPurify.sanitize(post_details.title)}}
                        >
                            {/* {post_title} */}
                        </h1>
                        {
                            ...
                            <div className="image_display">
                                <CloudinaryImage image_url={post_details.image}/>
                            </div>
                        }
                        <ParsedText>
                            {post_details.text}
            ...
            <div className="post_btns">
                ...
                <div className="both_comments_btns">
                    
                    {
                        ...
                        <Button 
                            handle_btn_click={() => {
                                set_show_comments_section(!show_comments_section)
