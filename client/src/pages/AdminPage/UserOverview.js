    ...
    return (
        <div className='UserOverview'>
            <div className="user_details">
                ...
                <div 
                    className={`is_online ${user_data.is_online ? "online" : ""}`} 
                >
            ...
            <div className="selection_cards_and_content">
                <div className="selection_cards">
                    <div 
                        className={`follower_card selection_card ${tabs.current_tab === "followers" ? "active" : ""}`}
                        onClick={() => set_tabs({
                            ...tabs,
                            current_tab: "followers"
                        })}
                    ...
                    <div 
                        className={`following_card selection_card ${tabs.current_tab === "following" ? "active" : ""}`}
                        onClick={() => set_tabs({
                            ...tabs,
                    ...
                    <div 
                        className={`following_card selection_card ${tabs.current_tab === "posts" ? "active" : ""}`}
                        onClick={() => set_tabs({
                            ...tabs,
                            current_tab: "posts"
                        })}
                    ...
                    <div 
                        className={`following_card selection_card ${tabs.current_tab === "profile_vistors" ? "active" : ""}`}
                        onClick={() => set_tabs({
                            ...tabs,
