        ...
        <div className="PasswordInput">
            ...
            <div className="errors">
                <ul>
                    ...
                    <li 
                        className={password_validity.lowercase_letter ? "valid" : "invalid"}
                    >1 Lowercase Letter</li>
                    <li 
                        className={password_validity.special_character ? "valid" : "invalid"}
                    >1 Special Character</li>
                    <li 
                        className={password_validity.number ? "valid" : "invalid"}
                    >1 Number</li>
                    <li 
                        className={password_validity.valid_length ? "valid" : "invalid"}
                    >{MIN_PASSWORD_LENGTH} Characters</li>
                </ul>
            </div>
        </div>
