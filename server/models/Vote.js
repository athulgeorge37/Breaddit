        ...
        validate: {
            ...
            validate_vote_combination() {
                ...
                if (this.post_id === null && this.comment_id === null) {
                    throw new Error("Both post_id and comment_id cannot be null, only 1 can be null")
                }
                ...
                if (this.post_id !== null && (this.parent_type === "comment" || this.parent_type === "reply")) {
                    throw new Error("Please ensure parent_type is 'post' when filling post_id")
                }

                if (this.comment_id !== null && this.parent_type === "post") {
                    throw new Error("Please ensure parent_type is 'comment' or 'reply' when filling comment_id")
                }
            }
        }
    })
